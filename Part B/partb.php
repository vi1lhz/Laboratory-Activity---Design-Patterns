...
foreach ($students as $studentData) {
    ...
    $image = $card->render();
    $filename = sprintf('%s/calling-card-%s-%s.png', $outputDirectory, strtolower($studentData['first_name']), strtolower($studentData['last_name']));

    if (imagepng($image, $filename)) {
        echo "Generated card for {$studentData['first_name']} {$studentData['last_name']} - {$filename}\n";
    } else {
        echo "ERROR: Failed to save card for {$studentData['first_name']} {$studentData['last_name']}\n";
    }
